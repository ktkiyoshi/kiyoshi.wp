<footer>
    <div id="footer" class="clearfix">
                ...
                <?php if ($archives) : ?>
                    <ul>
                        <?php foreach ($archives as $archive) : ?>
                            ...
                            <?php if ($m_cnt == 5) {
                                echo "<br class='display_pc' />";
                            } ?>
                            <?php if ($m_cnt == 3 || $m_cnt == 7) {
                                echo "<br class='display_sp' />";
                            } ?>
        ...
        <?php } ?>
        <?php require("parts/footer_profile.php"); ?>
    </div>
...
<script type="text/javascript" charset="utf-8" src="<?php echo get_template_directory_uri(); ?>/js/side-fixed.js"></script>
<script>
    (function($) {
        $(function() {
            var $header = $('#top-head');
